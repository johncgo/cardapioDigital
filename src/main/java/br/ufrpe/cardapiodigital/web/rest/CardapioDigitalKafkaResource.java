...
@RestController
@RequestMapping("/api/cardapio-digital-kafka")
public class CardapioDigitalKafkaResource {

    private final Logger log = LoggerFactory.getLogger(CardapioDigitalKafkaResource.class);
    ...
    public CardapioDigitalKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
